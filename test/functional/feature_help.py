...
"""Verify that starting vgccoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vgccoin with -h for help text")
        ...
        self.log.info("Start vgccoin with -version for version information")
        ...
        self.log.info("Start vgccoind with -fakearg to make sure it does not start")
