Contributing to Vgccoin Core
============================

The Vgccoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Vgccoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/vgccoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to vgccoin-qt
...
The following applies to code changes to the Vgccoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Vgccoin
Network Protocol consensus changes.

Whether a pull request is merged into Vgccoin Core rests with the project merge
...
Patches that change Vgccoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vgccoin consensus, it must have been
...
The project leader is the release manager for each Vgccoin Core release.
