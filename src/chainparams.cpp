...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 42;
        ...
        vSeeds.emplace_back("seed-a.vgccoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.vgccointools.com");
        vSeeds.emplace_back("dnsseed.vgccoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.vgccointools.com");
        vSeeds.emplace_back("seed-b.vgccoin.loshan.co.uk");
