...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vgccoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vgccoin-tx [options] <hex-tx> [commands]  Update hex-encoded vgccoin transaction\n" +
            "or:     vgccoin-tx [options] -create [commands]   Create hex-encoded vgccoin transaction\n" +
            "\n";
