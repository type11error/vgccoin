...
const char * const BITCOIN_CONF_FILENAME = "vgccoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vgccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Vgccoin";
#else
    // Unix-like
    return pathRet / ".vgccoin";
#endif
#endif
}
