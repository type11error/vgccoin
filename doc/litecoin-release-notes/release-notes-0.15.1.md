Vgccoin Core version *0.15.1* is now available from:

  <https://download.vgccoin.org/vgccoin-0.15.1/>
...
A number of changes to the way Vgccoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 credits per kB (0.00001 VGC). This is to prepare for dropping the minimum transaction fee to 0.1 credits per kB (0.0001 VGC) in the next release.
