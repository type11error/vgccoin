# Support for Output Descriptors in Vgccoin Core

Since Vgccoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Vgccoin Core wallets, a convenience function `combo` is
